		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<h4 class="panel-title">
					<a data-toggle="collapse" data-parent="#accordion" href="#<?php print($contact['contact_id']); ?>">
						<?php print($contact['contact_last_name'].' '.$contact['contact_first_name']); ?>
					</a>
					<a class="" href="index.php?action=editcontact&id=<?php print($contact['contact_id']); ?>">
						<span class="glyphicon glyphicon-pencil"></span>
					</a>
				</h4>
			</div>
			<div id="<?php print($contact['contact_id']); ?>" class="panel-collapse collapse">
